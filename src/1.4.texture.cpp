...
const char *vertexShaderSourcePath =
    "./1.4.texture-vertex.glsl";
const char *fragmentShaderSourcePath =
    "./1.4.texture-fragment.glsl";
...
public:
    ...
    void setup_shader() {
        ...
        // ------------------------------------
        m_program = std::make_shared<Shader>("./1.4.texture-vertex.glsl", "./1.4.texture-fragment.glsl");
    }
    void setup_vertices() {
    ...
    void setup_texture() {
        ...
        unsigned char *data = stbi_load("grass_side.png", &m_width, &m_height, &m_channel, 3);
        if (!data) {
