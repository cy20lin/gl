...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // https://stackoverflow.com/questions/24209550/gldrawelements-draw-polygon
        // GL_POLYGON is deprecated
        ...
        // glDrawElements(GL_LINES, 7, GL_UNSIGNED_INT, 0);
        // glDrawElements(GL_POINTS, 7, GL_UNSIGNED_INT, 0);
        ...
        // glDrawElements(GL_LINES_ADJACENCY, 8, GL_UNSIGNED_INT, 0);
